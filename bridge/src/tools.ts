...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    name: 'export_node',
    description:
      "Export a node. Formats: SVG, PNG, JPG, PDF (base64), CSS, JSON, and video MP4/GIF/WEBM. Constraint can be SCALE/WIDTH/HEIGHT. For PNG/JPG/PDF (and always for video), pass `path` — the bridge writes bytes to disk and returns {path, format, bytes} instead of base64. Without `path`, only small SVG/CSS/JSON are safe inline. Call grip_capabilities {tool:'export_node'} for video (animated-frame) rules and the response-cap lever.",
    detail:
